...
public class TemperatureSensorImpl extends DeviceImpl implements TemperatureSensor {
    private final TemperatureLimits maximumSupportedLimitsBySensor;
    private TemperatureLimits temperatureLimits;
    private float temperature;

    public TemperatureSensorImpl(TemperatureLimits temperatureLimits, float temperature) {
