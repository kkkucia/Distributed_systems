...
public interface LightBulbPrx extends DevicePrx
{
    ...
    default LedColour getColour()
    {
        return getColour(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default LedColour getColour(java.util.Map<String, String> context)
    {
        return _iceI_getColourAsync(context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<LedColour> getColourAsync()
    {
        return _iceI_getColourAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<LedColour> getColourAsync(java.util.Map<String, String> context)
    {
        return _iceI_getColourAsync(context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<LedColour> _iceI_getColourAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<LedColour> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "getColour", com.zeroc.Ice.OperationMode.Idempotent, sync, null);
        f.invoke(true, context, null, null, istr -> {
                     LedColour ret;
    ...
    default int setBrightness(int brightnessPercentage)
        throws BrightnessOutOfRangeException,
               DeviceIsOffException
    {
        return setBrightness(brightnessPercentage, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default int setBrightness(int brightnessPercentage, java.util.Map<String, String> context)
        throws BrightnessOutOfRangeException,
               DeviceIsOffException
    {
        try
        {
            return _iceI_setBrightnessAsync(brightnessPercentage, context, true).waitForResponseOrUserEx();
        }
        catch(BrightnessOutOfRangeException ex)
        {
            throw ex;
        }
    ...
    default java.util.concurrent.CompletableFuture<java.lang.Integer> setBrightnessAsync(int brightnessPercentage)
    {
        return _iceI_setBrightnessAsync(brightnessPercentage, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Integer> setBrightnessAsync(int brightnessPercentage, java.util.Map<String, String> context)
    {
        return _iceI_setBrightnessAsync(brightnessPercentage, context, false);
    }

    /**
     * @hidden
     * @param iceP_brightnessPercentage -
     * @param context -
     * @param sync -
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Integer> _iceI_setBrightnessAsync(int iceP_brightnessPercentage, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.Integer> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "setBrightness", com.zeroc.Ice.OperationMode.Idempotent, sync, _iceE_setBrightness);
        f.invoke(true, context, null, ostr -> {
                     ostr.writeInt(iceP_brightnessPercentage);
                 }, istr -> {
                     int ret;
                     ret = istr.readInt();
                     return ret;
    ...
    {
        BrightnessOutOfRangeException.class,
