...
public interface DevicePrx extends com.zeroc.Ice.ObjectPrx
{
        ...
        throws ModeNotChangeException
    {
        ...
        catch(ModeNotChangeException ex)
        {
            throw ex;
        }
    ...
    {
        com.zeroc.IceInternal.OutgoingAsync<Mode> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "setMode", com.zeroc.Ice.OperationMode.Idempotent, sync, _iceE_setMode);
    ...
    {
        ModeNotChangeException.class
    };

    default boolean isDeviceTurnOFF()
    {
        return isDeviceTurnOFF(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default boolean isDeviceTurnOFF(java.util.Map<String, String> context)
    {
        return _iceI_isDeviceTurnOFFAsync(context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.lang.Boolean> isDeviceTurnOFFAsync()
    {
        return _iceI_isDeviceTurnOFFAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Boolean> isDeviceTurnOFFAsync(java.util.Map<String, String> context)
    {
        return _iceI_isDeviceTurnOFFAsync(context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Boolean> _iceI_isDeviceTurnOFFAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.Boolean> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "isDeviceTurnOFF", com.zeroc.Ice.OperationMode.Idempotent, sync, null);
        f.invoke(true, context, null, null, istr -> {
                     boolean ret;
                     ret = istr.readBool();
                     return ret;
