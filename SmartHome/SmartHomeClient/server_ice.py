...
if 'LightBulbPrx' not in _M_SmartHome.__dict__:
    ...
    class LightBulbPrx(_M_SmartHome.DevicePrx):

        def getBrightness(self, context=None):
            return _M_SmartHome.LightBulb._op_getBrightness.invoke(self, ((), context))

        def getBrightnessAsync(self, context=None):
            return _M_SmartHome.LightBulb._op_getBrightness.invokeAsync(self, ((), context))

        def begin_getBrightness(self, _response=None, _ex=None, _sent=None, context=None):
            return _M_SmartHome.LightBulb._op_getBrightness.begin(self, ((), _response, _ex, _sent, context))

        def end_getBrightness(self, _r):
            return _M_SmartHome.LightBulb._op_getBrightness.end(self, _r)

        def getColour(self, context=None):
            return _M_SmartHome.LightBulb._op_getColour.invoke(self, ((), context))

        def getColourAsync(self, context=None):
            return _M_SmartHome.LightBulb._op_getColour.invokeAsync(self, ((), context))

        def begin_getColour(self, _response=None, _ex=None, _sent=None, context=None):
            return _M_SmartHome.LightBulb._op_getColour.begin(self, ((), _response, _ex, _sent, context))

        def end_getColour(self, _r):
            return _M_SmartHome.LightBulb._op_getColour.end(self, _r)

        def setBrightness(self, brightnessPercentage, context=None):
            return _M_SmartHome.LightBulb._op_setBrightness.invoke(self, ((brightnessPercentage, ), context))

        def setBrightnessAsync(self, brightnessPercentage, context=None):
            return _M_SmartHome.LightBulb._op_setBrightness.invokeAsync(self, ((brightnessPercentage, ), context))

        def begin_setBrightness(self, brightnessPercentage, _response=None, _ex=None, _sent=None, context=None):
            return _M_SmartHome.LightBulb._op_setBrightness.begin(self, ((brightnessPercentage, ), _response, _ex, _sent, context))

        def end_setBrightness(self, _r):
            return _M_SmartHome.LightBulb._op_setBrightness.end(self, _r)
    ...
    class LightBulb(_M_SmartHome.Device):

        def ice_ids(self, current=None):
            return ('::Ice::Object', '::SmartHome::Device', '::SmartHome::LightBulb')
    ...
    _M_SmartHome._t_LightBulbDisp = IcePy.defineClass('::SmartHome::LightBulb', LightBulb, (), None, (_M_SmartHome._t_DeviceDisp,))
    ...
    LightBulb._op_getColour = IcePy.Operation('getColour', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, False, None, (), (), (), ((), _M_SmartHome._t_LedColour, False, 0), ())
    LightBulb._op_setBrightness = IcePy.Operation('setBrightness', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, False, None, (), (((), IcePy._t_int, False, 0),), (), ((), IcePy._t_int, False, 0), (_M_SmartHome._t_BrightnessOutOfRangeException, _M_SmartHome._t_DeviceIsOffException))

    _M_SmartHome.LightBulb = LightBulb
    del LightBulb

_M_SmartHome._t_LightBulbLED = IcePy.defineValue('::SmartHome::LightBulbLED', Ice.Value, -1, (), False, True, None, ())

if 'LightBulbLEDPrx' not in _M_SmartHome.__dict__:
    _M_SmartHome.LightBulbLEDPrx = Ice.createTempClass()
    class LightBulbLEDPrx(_M_SmartHome.LightBulbPrx):

        def setLedColour(self, colour, context=None):
            return _M_SmartHome.LightBulbLED._op_setLedColour.invoke(self, ((colour, ), context))

        def setLedColourAsync(self, colour, context=None):
            return _M_SmartHome.LightBulbLED._op_setLedColour.invokeAsync(self, ((colour, ), context))

        def begin_setLedColour(self, colour, _response=None, _ex=None, _sent=None, context=None):
            return _M_SmartHome.LightBulbLED._op_setLedColour.begin(self, ((colour, ), _response, _ex, _sent, context))

        def end_setLedColour(self, _r):
            return _M_SmartHome.LightBulbLED._op_setLedColour.end(self, _r)

        @staticmethod
        def checkedCast(proxy, facetOrContext=None, context=None):
            return _M_SmartHome.LightBulbLEDPrx.ice_checkedCast(proxy, '::SmartHome::LightBulbLED', facetOrContext, context)

        @staticmethod
        def uncheckedCast(proxy, facet=None):
            return _M_SmartHome.LightBulbLEDPrx.ice_uncheckedCast(proxy, facet)

        @staticmethod
        def ice_staticId():
            return '::SmartHome::LightBulbLED'
    _M_SmartHome._t_LightBulbLEDPrx = IcePy.defineProxy('::SmartHome::LightBulbLED', LightBulbLEDPrx)

    _M_SmartHome.LightBulbLEDPrx = LightBulbLEDPrx
    del LightBulbLEDPrx

    _M_SmartHome.LightBulbLED = Ice.createTempClass()
    class LightBulbLED(_M_SmartHome.LightBulb):

        def ice_ids(self, current=None):
            return ('::Ice::Object', '::SmartHome::Device', '::SmartHome::LightBulb', '::SmartHome::LightBulbLED')
        ...
        def __str__(self):
            return IcePy.stringify(self, _M_SmartHome._t_LightBulbLEDDisp)

        __repr__ = __str__

    _M_SmartHome._t_LightBulbLEDDisp = IcePy.defineClass('::SmartHome::LightBulbLED', LightBulbLED, (), None, (_M_SmartHome._t_LightBulbDisp,))
    LightBulbLED._ice_type = _M_SmartHome._t_LightBulbLEDDisp

    LightBulbLED._op_setLedColour = IcePy.Operation('setLedColour', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, False, None, (), (((), _M_SmartHome._t_LedColour, False, 0),), (), ((), _M_SmartHome._t_LedColour, False, 0), (_M_SmartHome._t_DeviceIsOffException,))

    _M_SmartHome.LightBulbLED = LightBulbLED
    del LightBulbLED
...
_M_SmartHome._t_FreezerWithIceCubeMaker = IcePy.defineValue('::SmartHome::FreezerWithIceCubeMaker', Ice.Value, -1, (), False, True, None, ())

if 'FreezerWithIceCubeMakerPrx' not in _M_SmartHome.__dict__:
    _M_SmartHome.FreezerWithIceCubeMakerPrx = Ice.createTempClass()
    class FreezerWithIceCubeMakerPrx(_M_SmartHome.FridgePrx):

        def getCubesMakerCapacity(self, context=None):
            return _M_SmartHome.FreezerWithIceCubeMaker._op_getCubesMakerCapacity.invoke(self, ((), context))

        def getCubesMakerCapacityAsync(self, context=None):
            return _M_SmartHome.FreezerWithIceCubeMaker._op_getCubesMakerCapacity.invokeAsync(self, ((), context))

        def begin_getCubesMakerCapacity(self, _response=None, _ex=None, _sent=None, context=None):
            return _M_SmartHome.FreezerWithIceCubeMaker._op_getCubesMakerCapacity.begin(self, ((), _response, _ex, _sent, context))

        def end_getCubesMakerCapacity(self, _r):
            return _M_SmartHome.FreezerWithIceCubeMaker._op_getCubesMakerCapacity.end(self, _r)

        def getCubesQuantity(self, context=None):
            return _M_SmartHome.FreezerWithIceCubeMaker._op_getCubesQuantity.invoke(self, ((), context))

        def getCubesQuantityAsync(self, context=None):
            return _M_SmartHome.FreezerWithIceCubeMaker._op_getCubesQuantity.invokeAsync(self, ((), context))

        def begin_getCubesQuantity(self, _response=None, _ex=None, _sent=None, context=None):
            return _M_SmartHome.FreezerWithIceCubeMaker._op_getCubesQuantity.begin(self, ((), _response, _ex, _sent, context))

        def end_getCubesQuantity(self, _r):
            return _M_SmartHome.FreezerWithIceCubeMaker._op_getCubesQuantity.end(self, _r)

        def takeIceCubes(self, cubesQuantity, context=None):
            return _M_SmartHome.FreezerWithIceCubeMaker._op_takeIceCubes.invoke(self, ((cubesQuantity, ), context))

        def takeIceCubesAsync(self, cubesQuantity, context=None):
            return _M_SmartHome.FreezerWithIceCubeMaker._op_takeIceCubes.invokeAsync(self, ((cubesQuantity, ), context))

        def begin_takeIceCubes(self, cubesQuantity, _response=None, _ex=None, _sent=None, context=None):
            return _M_SmartHome.FreezerWithIceCubeMaker._op_takeIceCubes.begin(self, ((cubesQuantity, ), _response, _ex, _sent, context))

        def end_takeIceCubes(self, _r):
            return _M_SmartHome.FreezerWithIceCubeMaker._op_takeIceCubes.end(self, _r)

        def makeIceCubes(self, cubesQuantity, context=None):
            return _M_SmartHome.FreezerWithIceCubeMaker._op_makeIceCubes.invoke(self, ((cubesQuantity, ), context))

        def makeIceCubesAsync(self, cubesQuantity, context=None):
            return _M_SmartHome.FreezerWithIceCubeMaker._op_makeIceCubes.invokeAsync(self, ((cubesQuantity, ), context))

        def begin_makeIceCubes(self, cubesQuantity, _response=None, _ex=None, _sent=None, context=None):
            return _M_SmartHome.FreezerWithIceCubeMaker._op_makeIceCubes.begin(self, ((cubesQuantity, ), _response, _ex, _sent, context))

        def end_makeIceCubes(self, _r):
            return _M_SmartHome.FreezerWithIceCubeMaker._op_makeIceCubes.end(self, _r)

        @staticmethod
        def checkedCast(proxy, facetOrContext=None, context=None):
            return _M_SmartHome.FreezerWithIceCubeMakerPrx.ice_checkedCast(proxy, '::SmartHome::FreezerWithIceCubeMaker', facetOrContext, context)

        @staticmethod
        def uncheckedCast(proxy, facet=None):
            return _M_SmartHome.FreezerWithIceCubeMakerPrx.ice_uncheckedCast(proxy, facet)

        @staticmethod
        def ice_staticId():
            return '::SmartHome::FreezerWithIceCubeMaker'
    _M_SmartHome._t_FreezerWithIceCubeMakerPrx = IcePy.defineProxy('::SmartHome::FreezerWithIceCubeMaker', FreezerWithIceCubeMakerPrx)

    _M_SmartHome.FreezerWithIceCubeMakerPrx = FreezerWithIceCubeMakerPrx
    del FreezerWithIceCubeMakerPrx

    _M_SmartHome.FreezerWithIceCubeMaker = Ice.createTempClass()
    class FreezerWithIceCubeMaker(_M_SmartHome.Fridge):

        def ice_ids(self, current=None):
            return ('::Ice::Object', '::SmartHome::Device', '::SmartHome::FreezerWithIceCubeMaker', '::SmartHome::Fridge', '::SmartHome::TemperatureSensor')
        ...
        def __str__(self):
            return IcePy.stringify(self, _M_SmartHome._t_FreezerWithIceCubeMakerDisp)

        __repr__ = __str__

    _M_SmartHome._t_FreezerWithIceCubeMakerDisp = IcePy.defineClass('::SmartHome::FreezerWithIceCubeMaker', FreezerWithIceCubeMaker, (), None, (_M_SmartHome._t_FridgeDisp,))
    FreezerWithIceCubeMaker._ice_type = _M_SmartHome._t_FreezerWithIceCubeMakerDisp

    FreezerWithIceCubeMaker._op_getCubesMakerCapacity = IcePy.Operation('getCubesMakerCapacity', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, False, None, (), (), (), ((), IcePy._t_int, False, 0), ())
    FreezerWithIceCubeMaker._op_getCubesQuantity = IcePy.Operation('getCubesQuantity', Ice.OperationMode.Idempotent, Ice.OperationMode.Idempotent, False, None, (), (), (), ((), IcePy._t_int, False, 0), (_M_SmartHome._t_DeviceIsOffException,))
    FreezerWithIceCubeMaker._op_takeIceCubes = IcePy.Operation('takeIceCubes', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), IcePy._t_int, False, 0),), (), ((), IcePy._t_int, False, 0), (_M_SmartHome._t_LackOfIceCubesException, _M_SmartHome._t_QuantityOfIceCubesMustBeGraterThanZeroException, _M_SmartHome._t_DeviceIsOffException))
    FreezerWithIceCubeMaker._op_makeIceCubes = IcePy.Operation('makeIceCubes', Ice.OperationMode.Normal, Ice.OperationMode.Normal, False, None, (), (((), IcePy._t_int, False, 0),), (), ((), IcePy._t_int, False, 0), (_M_SmartHome._t_QuantityOfIceCubesMustBeGraterThanZeroException, _M_SmartHome._t_DeviceIsOffException))

    _M_SmartHome.FreezerWithIceCubeMaker = FreezerWithIceCubeMaker
    del FreezerWithIceCubeMaker
